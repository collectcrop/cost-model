...
\begin{aligned}
    \mathbb{E}[\text{DAC}] &= \sum_{s=0}^{C_{\text{ipp}}-1} \frac{1}{C_{ipp}}\Big(1+(\lambda+\mathbbm{1}_{\{s<r\}})+(\lambda+\mathbbm{1}_{\{s>C_{ipp}-1-r\}}) \Big) \\
    &= 1+2\lambda+\frac{2r}{C_{\text{ipp}}} = 1+\frac{2\varepsilon}{C_{\text{ipp}}}.
\end{aligned}
\end{equation}
\end{proof}
...
\section{Extended Experimental Evaluation}
...
\centering
    \begin{subfigure}[b]{0.48\linewidth}
        ...
        \label{fig:throughput_heatmap_0MB}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/heatmap_latency_ms_0MB.pdf}
        \caption{Latency (ms) without page buffer.}
        \label{fig:latency_heatmap_0MB}
    \end{subfigure}

    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/heatmap_throughput_qps_100KB.pdf}
        \caption{Throughput (KOPS) with 100KB page buffer.}
        \label{fig:throughput_heatmap_100KB}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/heatmap_latency_ms_100KB.pdf}
        \caption{Latency (ms) with 100KB page buffer.}
        \label{fig:latency_heatmap_100KB}
    \end{subfigure}

    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/heatmap_throughput_qps_1MB.pdf}
        \caption{Throughput (KOPS) with 1MB page buffer.}
        \label{fig:throughput_heatmap_1MB}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/heatmap_latency_ms_1MB.pdf}
        \caption{Latency (ms) with 1MB page buffer.}
        \label{fig:latency_heatmap_1MB}
    \end{subfigure}
